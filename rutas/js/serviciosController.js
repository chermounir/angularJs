app.controller('serviciosController', ['$scope', '$http', '$q', '$timeout', function($scope, $http, $q, $timeout){


  console.trace('serviciosController');
  $scope.titulo = "servicios - Ejercicio";
  $scope.sumar1 = 0;
  ...
  $scope.sumar( 2, 3 , true, 2000 ).then(function (result) {
